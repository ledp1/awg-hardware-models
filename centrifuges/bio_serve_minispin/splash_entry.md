# BioServe MiniSpin — SPLASH Entry
...
- **Power:** 120 V AC, ~70–85 W average
...
- **Interface Definitions:** 120 V AC power, manual front panel control
...
- **Imaging:** No (external)
- **Key Applications:** Microcentrifuge runs; glovebox/MWA/LSG compatible

## Logistics
- **Crew Handling Required:** Yes (manual loading/operation)
- **Crew Time:** Required for loading and operation
- **Autonomy:** No (manual)
