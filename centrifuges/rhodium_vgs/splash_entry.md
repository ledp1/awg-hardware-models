...
## Specifications
- **Mass:** TBD (per Rhodium Scientific / ISS National Lab documentation)
- **Size:** ISS internal facility
- **Power:** TBD (per ISS allocation)
- **Centrifuge Performance:** Low-speed, high-throughput; Lunar, Martian, and Earth gravity simulation
- **Temperature Range:** TBD (ambient ISS; mission-dependent configuration)
...
- **Heat Sink Required:** TBD (as per facility design)
